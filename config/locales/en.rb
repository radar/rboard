{
  :'en' => {
   ...
   :Home => "Home",
   :I_have_attachments => "I have attachments",
   :In => "In",
   :in => "in",
   :Inbox => "Inbox",
   :Index => "Index",
   ...
   :Now_you_may_attach_files => "Now you may attach files to your post.",
   ...
   :You_cannot_post_attachments_in_this_forum => "You cannot post attachments in this forum.",
